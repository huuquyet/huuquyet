...
<!-- START_CAPTION -->
*A vibrant coral reef teeming with colorful, tropical fish* by [stabilityai/stable-diffusion-xl-base-1.0](https://hf.co/stabilityai/stable-diffusion-xl-base-1.0)
<!-- END_CAPTION -->
  </div>
  <div align="right">
