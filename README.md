...
<!-- START_CAPTION -->
*A towering iceberg, gleaming in the polar sunlight, set against the endless expanse of the icy sea* by [stabilityai/stable-diffusion-xl-base-1.0](https://hf.co/stabilityai/stable-diffusion-xl-base-1.0)
<!-- END_CAPTION -->
  </div>
  <div align="right">
