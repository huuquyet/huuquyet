...
<!-- START_CAPTION -->
*A celestial display of the Aurora Borealis over a tranquil frozen lake* by [stable-diffusion-v1-5/stable-diffusion-v1-5](https://hf.co/stable-diffusion-v1-5/stable-diffusion-v1-5)
<!-- END_CAPTION -->
  </div>
  <div align="right">
