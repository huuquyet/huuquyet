...
<!-- START_CAPTION -->
*A labyrinthine network of frost patterns on a clear glass pane* by [stabilityai/stable-diffusion-xl-base-1.0](https://hf.co/stabilityai/stable-diffusion-xl-base-1.0)
<!-- END_CAPTION -->
  </div>
  <div align="right">
