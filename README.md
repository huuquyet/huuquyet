...
<!-- START_CAPTION -->
*A field of blooming tulips waving under a springtime breeze* by [stabilityai/stable-diffusion-xl-base-1.0](https://hf.co/stabilityai/stable-diffusion-xl-base-1.0)
<!-- END_CAPTION -->
  </div>
  <div align="right">
