...
<!-- START_CAPTION -->
*A field of lavender swaying gently under a dramatic sunset* by [stabilityai/stable-diffusion-xl-base-1.0](https://hf.co/stabilityai/stable-diffusion-xl-base-1.0)
<!-- END_CAPTION -->
  </div>
  <div align="right">
