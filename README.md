...
<!-- START_CAPTION -->
*A stunning lotus pond with petals gently floating on the surface* by [stabilityai/stable-diffusion-xl-base-1.0](https://hf.co/stabilityai/stable-diffusion-xl-base-1.0)
<!-- END_CAPTION -->
  </div>
  <div align="right">
