...
<!-- START_CAPTION -->
*A field of blooming tulips, their myriad colors creating a mesmerizing mosaic* by [stable-diffusion-v1-5/stable-diffusion-v1-5](https://hf.co/stable-diffusion-v1-5/stable-diffusion-v1-5)
<!-- END_CAPTION -->
  </div>
  <div align="right">
