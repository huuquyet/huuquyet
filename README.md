...
<!-- START_CAPTION -->
*A breathtaking aurora borealis display dancing across a pristine, snow-covered arctic tundra* by [stabilityai/stable-diffusion-2-1](https://hf.co/stabilityai/stable-diffusion-2-1)
<!-- END_CAPTION -->
  </div>
  <div align="right">
